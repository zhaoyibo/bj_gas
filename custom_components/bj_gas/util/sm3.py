...
:author: yibo
:date: 2023-01-09
:description: SM3加密算法。 适用于 python2.7+, python3.5+(用 python3 时暂不支持对中文的加密)
"""
...
if __name__ == "__main__":
    s1 = 'ggDUwMDS1XEaCCpou/GDKEGMk9Qicb/STary8FNMe3x6T7KDafV3YdyNIKx2psrj+urwaw5SOSq9Hh08IHkSbIUcoCRTDOlr'
